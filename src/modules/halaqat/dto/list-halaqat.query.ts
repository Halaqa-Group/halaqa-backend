...
export class ListHalaqatQuery {
  ...
  @ApiProperty({
    required: false,
    example: 5,
    description: 'Filter to halaqat supervised by this user.',
  })
  @IsOptional()
  @Type(() => Number)
  @IsInt()
  ...
  @ApiProperty({
    ...
    example: 12,
    description:
      'Filter to halaqat where this teacher has an active assignment.',
  })
  @IsOptional()
  @Type(() => Number)
  @IsInt()
  ...
  @ApiProperty({
    ...
    example: 'فجر',
    maxLength: 100,
    description: 'Substring match on halaqa name.',
  })
  @IsOptional()
  @IsString()
  @MaxLength(100)
