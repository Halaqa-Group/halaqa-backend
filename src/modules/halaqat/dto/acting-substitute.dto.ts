...
export class ActingSubstituteDto {
  @ApiProperty({
    example: 18,
    description:
      'Must be a user in this school with the teacher role, not already actively assigned here.',
  })
  @IsInt()
  @IsPositive()
  ...
  @ApiProperty({
    ...
    example: '2026-05-10',
    description:
      '<= today. Substitutes cannot be future-dated; acting_as_primary is set to 1 immediately.',
  })
  @IsDateString()
  ...
  @ApiProperty({
    required: false,
    example: "Substitute for A's annual leave",
    maxLength: 255,
  })
  @IsOptional()
  @IsString()
