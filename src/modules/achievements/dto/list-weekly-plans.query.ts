...
export class ListWeeklyPlansQuery {
  ...
  @ApiProperty({ required: false, format: 'date', example: '2026-05-09', description: 'Filter by week start date.' })
  @IsOptional()
  @IsDateString()
  week_start_date?: string;

  @ApiProperty({ required: false, enum: ['draft', 'approved'], example: 'draft' })
  @IsOptional()
