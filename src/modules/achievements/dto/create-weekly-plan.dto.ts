...
import { ArrayMinSize, IsDateString, IsInt, ValidateNested } from 'class-validator';
...
export class CreateWeeklyPlanDto {
  ...
  @ApiProperty({ example: 3, description: 'Halaqa ID. Caller must have primary-teacher authority.' })
  @Type(() => Number)
  @IsInt()
  halaqa_id!: number;

  @ApiProperty({ format: 'date', example: '2026-05-09', description: 'Saturday that starts the week.' })
  @IsDateString()
